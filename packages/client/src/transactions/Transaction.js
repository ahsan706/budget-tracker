  ...
  render() {
    ...
    return (
      <Grid className={classes.root}>
        <Button className={classes.addButton} variant="contained" onClick={() => this.showAddTransaction()}>
          Add Transaction
        </Button>
        <SingleTransactionView editTransaction={this.state.editTransaction} updatedOrCreatedTransaction={this.updatedOrCreatedTransaction.bind(this)} dialogClosed={this.dialogClosed.bind(this)} open={this.state.openSingleTransactionView}/>
